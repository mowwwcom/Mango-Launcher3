...
public class AutoInstallsLayout {
    ...
    private static final String ATTR_CLASSIFY = "classify";
    ...
    protected class FolderParser implements TagParser {
        ...
        public long parseAndAdd(XmlResourceParser parser)
            ...
            final String title;
            final int titleResId = getAttributeResourceValue(parser, ATTR_TITLE, 0);
            final int classify = Integer.valueOf(getAttributeValue(parser, ATTR_CLASSIFY));
            if (titleResId != 0) {
            ...
            mValues.put(Favorites.TITLE, title);
            mValues.put(Favorites.CLASSIFY, classify);
            ...
            if (FavoriteSettings.Classify.isNoType(classify)
                    && folderItems.size() < 2) {
                // Delete the folder
                ...
                if (folderItems.size() == 1) {
                    ...
                    mDb.update(Favorites.TABLE_NAME_STANDARD, childValues,
                            Favorites._ID + "=" + addedId, null);
                }
            }
            return addedId;
