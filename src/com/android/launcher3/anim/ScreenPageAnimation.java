...
/**
 * <string name="pageanim_normal">默认</string>
 * <string name="pageanim_turntable">风车</string>
 * <string name="pageanim_layered">深景</string>
 * <string name="pageanim_rotate">旋转</string>
 * <string name="pageanim_pageturn">翻页</string>
 * <string name="pageanim_rotatebylefttoppoint">卡片</string>
 * <string name="pageanim_rotatebycenterpoint">罗盘</string>
 * <string name="pageanim_blocks">方盒</string>
 *
 * @author tic
 */
public class ScreenPageAnimation {
    ...
    private static ScreenPageAnimation mInstance;
    ...
    public static ScreenPageAnimation getInstance() {
        if (mInstance == null) {
            synchronized (ScreenPageAnimation.class) {
                if (mInstance == null) {
                    mInstance = new ScreenPageAnimation();
                }
            }
        }
